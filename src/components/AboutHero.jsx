...
import { ContactMail, KeyboardArrowDown } from "@mui/icons-material";
        ...
        <Grid container spacing={4} alignItems="center">
          ...
          <Grid item xs={12} md={6}>
            <Box sx={{ textAlign: { xs: "center", md: "left" } }}>
              ...
              >
                Somos un equipo apasionado dedicado a transformar <br />
                la agricultura peruana a través de la innovación tecnológica.
              </Typography>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <Box
                component="img"
                src="https://media.istockphoto.com/id/1451084434/es/foto/agricultor-y-agr%C3%B3nomo-usando-una-tableta-digital-mientras-est%C3%A1-parado-en-el-campo-de-ma%C3%ADz.jpg?s=612x612&w=0&k=20&c=ls7I2rIapNx9sjPCx4C0clkX6XQYMjs4ImtrE_rc-1M="
                alt="Agricultor y agrónomo usando tecnología digital - AgroPE"
                sx={{
                  width: "100%",
